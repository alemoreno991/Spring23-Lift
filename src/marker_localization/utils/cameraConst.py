...
IRSCAM_POSX_B = 0. # METERS
IRSCAM_POSY_B = 0. # METERS
IRSCAM_POSZ_B = -1. # METERS
...
HSCAM_FOV = 2 * 60 # DEGREES
HSCAM_IMAGE_PHEIGHT = 1920 # PIXELS
HSCAM_IMAGE_PWIDTH = 1920 # PIXELS

HSCAM_POSX_B = 0. # METERS
HSCAM_POSY_B = 1.6 # METERS
HSCAM_POSZ_B = 0. # METERS

HSCAM_RPY_R_CB = -90. # DEGREES 
HSCAM_RPY_P_CB =   0. # DEGREES 
HSCAM_RPY_Y_CB = -90. # DEGREES 
...
CAM_POSX_B = None # METERS
CAM_POSY_B = None # METERS
CAM_POSZ_B = None # METERS
...
if CAMERA_MODEL == 0:
    ...
    CAM_POSX_B = IRSCAM_POSX_B # METERS
    CAM_POSY_B = IRSCAM_POSY_B # METERS
    CAM_POSZ_B = IRSCAM_POSZ_B # METERS
    ...
    CAM_POSX_B = HSCAM_POSX_B # METERS
    CAM_POSY_B = HSCAM_POSY_B # METERS
    CAM_POSZ_B = HSCAM_POSZ_B # METERS
...
CAM_POS_B  = np.array( [ [CAM_POSX_B], [CAM_POSY_B], [CAM_POSZ_B] ] ) # METERS
